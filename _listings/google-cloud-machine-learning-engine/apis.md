...
- name: Google Cloud Machine Learning API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-cloud-machine-learning-engine/master/_listings/google-cloud-machine-learning-engine/v1-parent-versions-post.md
x-common:
- type: x-change-log
